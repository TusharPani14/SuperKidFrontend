                ...
                <Toolbar disableGutters>
                    ...
                    <Box sx={{ flexGrow: 1, display: { xs: 'flex', md: 'none' } }}>
                        ...
                        >
                            ...
                            <MenuItem color="inherit" sx={{ fontWeight: "600", fontSize: { xs: "13px", lg: "15px" } }}>Home</MenuItem>
                        ...
                        <Tooltip title="Open settings">
                            <IconButton onClick={handleOpenUserMenu} sx={{ p: 0 }}>
                                <Link href={{ pathname: '/register', query: { price: 349 } }}>
                                    <Button variant="contained" sx={{ background: "linear-gradient(0deg, #FCD281 0%, #FBCF7A 15%, #FAC669 35.99%, #F7B94D 59.99%, #F4A627 85.99%, #F39B0E 99.98%)", borderRadius: "52.8079px", fontWeight: "700", color: "#000", fontSize: "14px", textTransform: "none" }} className='list'
                                    >
                                        Register Now
                                    </Button>
                                </Link>
