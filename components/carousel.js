...
const MultiCarousel = () => {
  ...
  return (
    ...
    >
      {data.map((item) => (
        <Box key={item.id} sx={{ textAlign: 'center' , background:"#F9A23D" , border:"2.11232px solid #455A64" , borderRadius:"29.5724px" , display:"flex" , flexDirection:"column" , justifyContent:"center" , alignItems:"center" , height:"420px" , width:"auto" ,padding:"0 0.5em" , gap:"5px",marginTop:"20px"}}>
